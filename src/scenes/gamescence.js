...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        wasteLayer = map.getObjectLayer('Waste')['objects'];
        ...
        wasteObjects = this.physics.add.staticGroup();
      
        wasteLayer.forEach(object => {
          let obj = wasteObjects.create(object.x, object.y, "waste"); 
             obj.setScale(object.width/16, object.height/16); 
             obj.setOrigin(0); 
             obj.body.width = object.width; 
             obj.body.height = object.height; 
      });
      this.physics.add.overlap(player, wasteObjects, this.collectWaste, null, this);
    ...
    collectWaste(player, wasteObject) {
        wasteObject.destroy(wasteObject.x, wasteObject.y); // remove the tile/coin
        score++// increment the score
        text.setText(`Coins: ${score}x`); // set the text to show the current score
